defmodule RbagElectionsWeb.AdminConfirmationLiveTest do
  ...
  describe "Confirm admin" do
    ...
    test "confirms the given token once", %{conn: conn, admin: admin} do
      ...
      assert Management.get_admin!(admin.id).confirmed_at
    ...
    test "does not confirm email with invalid token", %{conn: conn, admin: admin} do
      ...
      refute Management.get_admin!(admin.id).confirmed_at
    end
  end
end
