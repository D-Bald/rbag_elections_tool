defmodule RbagElections.Management.Admin do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, RbagElections.Repo)
  ...
  """
  def valid_password?(%RbagElections.Management.Admin{hashed_password: hashed_password}, password)
