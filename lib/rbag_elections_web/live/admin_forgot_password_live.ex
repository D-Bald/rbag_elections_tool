defmodule RbagElectionsWeb.AdminForgotPasswordLive do
  ...
  def handle_event("send_email", %{"admin" => %{"email" => email}}, socket) do
    if admin = Management.get_admin_by_email(email) do
      Management.deliver_admin_reset_password_instructions(
        admin,
