defmodule RbagElectionsWeb.AdminRegistrationLive do
  use RbagElectionsWeb, :live_view

  alias RbagElections.Management
  alias RbagElections.Management.Admin
  ...
  def handle_event("validate", %{"admin" => admin_params}, socket) do
    changeset = Management.change_admin_registration(%Admin{}, admin_params)
